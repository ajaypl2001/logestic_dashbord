                              ...
                              <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <select class="form-control required" id="dispatcher" name="dispatcher">
                                             ...
                                             <option value="Ajay pal test" {{$isEdit && $load->dispatcher == 'Ajay pal test' ? 'selected' : '' }}>Ajay pal test</option>
                                          </select>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="text" id="wo" name="wo" class="form-control required" value="{{ $isEdit ? $load->wo : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="mb-3">
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="text" id="type" name="type" class="form-control required" value="{{ $isEdit ? $load->type : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          <label class="control-label mb-1">Shipper Rate</label><span style="color:red;">*</span>
                                          <input type="text" id="shipper_rate" name="shipper_rate" class="form-control required" value="{{ $isEdit ? $load->shipper_rate : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="number" id="fsc" max="9999999999" name="fsc" class="form-control required" value="{{ $isEdit ? $load->fsc : '' }}" />
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="text" id="other_charge_id" name="other_charge_id" readonly class="form-control required" value="{{ $isEdit ? $load->other_charge_id : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="number" id="adv_payment" name="adv_payment" class="form-control required" value="{{ $load->adv_payment ?? '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          <label class="control-label mb-1">Load Type</label><span style="color:red;">*</span>
                                          <select class="form-control required" id="load_type" name="load_type">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <select class="form-control required" id="bill_type" name="bill_type">
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="text" id="mc_no" name="mc_no" class="form-control required" value="{{ $isEdit ? $load->mc_no : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <select class="form-control required" id="equipment_type" name="equipment_type">
                                             <option value="" disabled>--select--</option>
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="text" id="carrier_fee" name="carrier_fee" class="form-control number required" value="{{ $isEdit ? $load->carrier_fee : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          <label class="control-label mb-1">P/D s</label>
                                          <input type="number" id="txtCarrierPDS" class="form-control required" name="carrier_pds" value="{{ $isEdit ? $load->carrier_pds : '' }}" />
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group mb-3">
                                          ...
                                          <input type="number" id="txtCarrierfscrate" min="0" max="100" class="form-control required" name="carrierrate" value="{{ $isEdit ? $load->carrierrate : '' }}" />
                                       </div>
                                    </div>
                                    {{-- <div class="col-md-3">
                                       <div class="form-group mb-3">
                                       ...
                                       <div class="row">
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <select class="form-control shadow-none col-12 shipper_id required" name="shipper_details[{{ $i }}][shipper_id]" data-choices>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control loc required" id="shipper_details[{{ $i }}][shipper_location]" name="shipper_details[{{ $i }}][shipper_location]" readonly />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="date" class="form-control datepicker required" name="shipper_details[{{ $i }}][shipper_date]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <select class="form-control drpShipperTime required" name="shipper_details[{{ $i }}][shipper_chktime]"></select>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control required" name="shipper_details[{{ $i }}][shipper_description]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control required" name="shipper_details[{{ $i }}][shipper_type]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control number required" name="shipper_details[{{ $i }}][shipper_qty]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control number required" name="shipper_details[{{ $i }}][shipper_weight]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control number required" name="shipper_details[{{ $i }}][shipper_value]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control required" name="shipper_details[{{ $i }}][shipping_notes]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control required" name="shipper_details[{{ $i }}][po_number]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <select class="form-control drpCustomBroker required" name="shipper_details[{{ $i }}][customer_broker]">
                                       ...
                                       <div class="row">
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <select class="form-control shadow-none col-12 consignee_id required" name="consignee_details[{{ $i }}][consignee_id]" data-choices>
                                                   <option value="">Please Select</option>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Location</label>
                                                <input type="text" class="form-control conloc required" id="consignee_details[{{ $i }}][consignee_location]" name="consignee_details[{{ $i }}][consignee_location]" readonly />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Date</label><span style="color:red;">*</span>
                                                <input type="date" class="form-control datepicker greaterThan required" name="consignee_details[{{ $i }}][consignee_date]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <select class="form-control drpConsigneeTime required" name="consignee_details[{{ $i }}][consignee_time]"></select>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Description</label>
                                                <input type="text" class="form-control required" name="consignee_details[{{ $i }}][consignee_description]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Type (TL,LTL,Pallets,etc)</label>
                                                <input type="text" class="form-control required" name="consignee_details[{{ $i }}][consignee_type]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Qty</label>
                                                <input type="text" class="form-control number required" name="consignee_details[{{ $i }}][consignee_quantity]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Weight(lbs)</label>
                                                <input type="text" class="form-control number required" name="consignee_details[{{ $i }}][consignee_weight]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">Value($)</label><span style="color:red;">*</span>
                                                <input type="text" class="form-control number required" name="consignee_details[{{ $i }}][consignee_value]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control required" name="consignee_details[{{ $i }}][delivery_notes]" />
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                             <div class="form-group mb-3">
                                                <label class="control-label mb-1">P.O Numbers</label>
                                                <input type="text" class="form-control required" name="consignee_details[{{ $i }}][consignee_po_number]" />
                                             </div>
                                          </div>
