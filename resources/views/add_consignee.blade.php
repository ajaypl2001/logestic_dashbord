                           ...
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <input Placeholder="Name" class="form-control" id="ConsignName" name="ConsignName" type="text" value="{{ $isEdit ? $Consignees->name : '' }}" required/>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Address</label>
                                    <input Placeholder="Address" class="form-control" id="AddressL1" name="AddressL1" type="text" value="{{ $isEdit ? $Consignees->addressl_1 : '' }}" required/>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <select class="form-control shadow-none col-12" data-val="true" data-val-required="Country is required" id="strCountryID" name="country" required>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <select class="form-control shadow-none col-12" id="strStateID" name="state" required>
                                       <option value="">Please Select</option>
                                    </select>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <input Placeholder="City" class="form-control" id="City" name="City" type="text" value="{{ $isEdit ? $Consignees->city : '' }}" required/>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Zip</label><span style="color:red">*</span>
                                    <input Placeholder="Zip" class="form-control" id="ZipCode" name="ZipCode" type="text" value="{{ $isEdit ? $Consignees->zip_code : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Contact Name</label>
                                    <input Placeholder="Contact Name" class="form-control" id="ContactName" name="ContactName" type="text" value="{{ $isEdit ? $Consignees->contact_name : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Contact Email</label>
                                    <input Placeholder="Contact Email" class="form-control" id="ContactEmail" name="ContactEmail" type="text" value="{{ $isEdit ? $Consignees->contact_email : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Telephone</label><span style="color:red">*</span>
                                    <input Placeholder="XXX-XXX-XXXX" class="form-control phone telephone" id="Telephone" name="Telephone" type="text" value="{{ $isEdit ? $Consignees->tele_phone : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Ext</label>
                                    <input Placeholder="Ext." class="form-control" id="TelephoneExt" name="TelephoneExt" type="number" value="{{ $isEdit ? $Consignees->telephone_ext : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Toll Free</label>
                                    <input Placeholder="XXX-XXX-XXXX" class="form-control telephone" id="TollFree" name="TollFree" type="text" value="{{ $isEdit ? $Consignees->toll_free : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="control-label mb-1">Fax</label>
                                    <input Placeholder="XXX-XXX-XXXX" class="form-control telephone" id="Fax" name="Fax" type="text" value="{{ $isEdit ? $Consignees->fax : '' }}" required />
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <select class="form-control shadow-none col-12" id="strAppointments" name="strAppointments" required>
                                       <option value="">Please Select</option>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <input Placeholder="Major Intersections/Directions" class="form-control" id="MajorInspectionDirections" name="MajorInspectionDirections" type="text" value="{{ $isEdit ? $Consignees->major_inspection_Dir : '' }}" required />
                                 </div>
                              </div>
                              <!-- <div class="col-md-4">
                                 <div class="form-group mb-3">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group text-center mb-3">
                                    ...
                                    <input class="form-check-input" id="as_shipper" name="as_shipper" type="checkbox" value="Yes" {{ ($isEdit && $Consignees->as_shipper == 'Yes') ? 'checked' : '' }} required>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <select class="form-control shadow-none col-12" id="strStatusInd" name="strStatusInd" width="100px" required>
                                       <option value="">Please Select</option>
